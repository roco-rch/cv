...
export const timelineData: TimelineEvent[] = [
  {
    id: 'metier2',
    title: 'Water Growth Capital',
    date: new Date('2033-02-01'),
    type: 'event',
    location: 'New York',
    shortDescription: 'Private Equity Analyst',
  ...
  },
  {
    ...
    description: 'Rejoint le desk Dérivés de Lazard Asset Management à Amsterdam pour contribuer à la structuration et à la gestion de stratégies sur produits dérivés (options, futures, swaps), au sein d’une équipe multi-actifs.',
...

{
    ...
    type: 'event',
    location: 'Hong-Kong',
    shortDescription: 'VIE Hong-Kong',
    description:
